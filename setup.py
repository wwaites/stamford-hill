...
setup(name='stamford',
      ...
      entry_points={
          ...
          'netkappa_functions': [
              ...
              'sus = stamford.network:sus',
              'sbal = stamford.network:sbal',
          ],
          'netabc_commands': [
              ...
              'write_stamford_demo = stamford.plot:write_stamford_demo',
              ...
              'write_stamford_sero = stamford.plot:write_stamford_sero',
          ],
      },
)
